...
> **What just happened:** You built the flow that turns the agent's AI-generated text into a permanent document. The file name includes the year and month (`MBR-Report-2026-04.docx`) so each month's report is kept in MBR Output as a running archive.
